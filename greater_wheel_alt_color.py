...
# 2023 Beaver Greater Wheel Mod by alt color
#
...
class MountOlympus_RowStack(AC_RowStack):
    def getHelp(self):
...
# register the game
registerGame(GameInfo(3976, GreatWheel, "Great Wheel Alt Color",
                      GI.GT_2DECK_TYPE | GI.GT_STRIPPED, 2, 0, GI.SL_BALANCED,
                      ranks=list(range(12))  # without Kings
                      ))
registerGame(GameInfo(7826, GreaterWheel, "Greater Wheel Alt Color",
