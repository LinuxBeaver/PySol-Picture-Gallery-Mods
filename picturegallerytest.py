...
# register the game
registerGame(GameInfo(900008, BigPictureGallery, "Big Picture Gallery (Plugin)",
                      GI.GT_3DECK_TYPE, 3, 0, GI.SL_BALANCED))
registerGame(GameInfo(900009, HugePictureGallery, "Huge Picture Gallery (Plugin)",
                      GI.GT_4DECK_TYPE, 4, 0, GI.SL_BALANCED))
registerGame(GameInfo(900010, SmallPictureGallery, "Small Picture Gallery (Plugin)",
